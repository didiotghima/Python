...
with open("C:/Users/USER/Desktop/homework_2/hw_5/hw_6/MOCK_DATA.txt", "r", encoding='utf-8') as file:
    content = file.read()
...
for data in fails:
    if data.full_name in full_name_list:
        with open("C:/Users/USER/Desktop/homework_2/hw_5/hw_6/FIO.txt", "w") as f:
            f.write(data.full_name)
    if data.email in email_list:
        with open("C:/Users/USER/Desktop/homework_2/hw_5/hw_6/email.txt", "w") as f:
            f.write(data.email)
    if data.file_name in file_list:
        with open("C:/Users/USER/Desktop/homework_2/hw_5/hw_6/filename.txt", "w") as f:
            f.write(data.file_name)
    if data.color in color_list:
        with open("C:/Users/USER/Desktop/homework_2/hw_5/hw_6/color.txt", "w") as f:
            f.write(data.color)
